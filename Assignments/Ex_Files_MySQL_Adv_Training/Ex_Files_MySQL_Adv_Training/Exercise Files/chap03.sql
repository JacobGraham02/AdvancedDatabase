...
RETURNS VARCHAR(16)
DETERMINISTIC -- No SQL - no SQL statements; Reads Sql - SELECT; Modifies SQL - INSERT or DELETE
BEGIN
    RETURN CONCAT_WS(':', seconds DIV 60, LPAD(seconds MOD 60, 2, '0' )); -- CONCAT with separator
END //
DELIMITER ;
